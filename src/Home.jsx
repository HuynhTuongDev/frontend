        ...
        <>
            ...
            <main className="p-4">
                ...
                <div className="mt-10">
                    ...
                    {/* New Product */}
                    <section className="bg-cover bg-center p-5 rounded-2xl text-white" style={{ backgroundImage: "url('https://cdn2.fptshop.com.vn/unsafe/1920x0/filters:quality(100)/desk_header_bg_5c0b940e70.png')" }}>
                    ...
                    {/* Best Seller */}
                    <section className="bg-cover bg-center p-5 rounded-2xl text-white" style={{ backgroundImage: "url('https://cdn2.fptshop.com.vn/unsafe/1920x0/filters:quality(100)/Backgroung_gia_online_D_2_a2745b43fc.png')" }}>
