...
const Header = () => {
    return (
        <div className="bg-red-600 py-2 w-screen absolute top-0 left-0 z-50">
                    ...
                    <div className="w-full lg:w-5/12 mb-4 lg:mb-0">
                        <div className="flex items-center space-x-2">
                            <marquee behavior="scroll" direction="left" className="text-white text-sm">
                                Chào mừng bạn đến với  Space Phone Technology. Nếu bạn cần giúp đỡ, Hãy liên lạc với chúng tôi qua số hotline: (+84) 766024998 hoặc email: @gmail.com
                            </marquee>
                        </div>
                    </div>
